...
class Dashboard {
  ...
  toggle(n, v) { v ? this.selected.add(n) : this.selected.delete(n); this.updateLabel(); this.refresh(); }
  msAll()      { this.selected.clear(); this.rebuildOpts(document.getElementById('ms-q').value); this.updateLabel(); this.refresh(); }
  msClear()    { this.msAll(); }
